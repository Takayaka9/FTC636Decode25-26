...
abstract class PedroUpdate extends Initializer {
    ...
    public final boolean checkShoot(int time) {
        return shootTimer.milliseconds() >= time;
    }
