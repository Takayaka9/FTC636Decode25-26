...
//        private static double oKd2 = 0.0001;
    ...
    private double getGoalAngle(Pose pose){
        ...
        if(alliance == Alliance.BLUE){
            goalAngle = Math.atan2(LocalizationHelper.goalPoses.blueY - pose.getY(), LocalizationHelper.goalPoses.blueX - pose.getX());
        }
        if(alliance == Alliance.RED){
            goalAngle = Math.atan2(LocalizationHelper.goalPoses.redY - pose.getY(), LocalizationHelper.goalPoses.redX - pose.getX());
        }
