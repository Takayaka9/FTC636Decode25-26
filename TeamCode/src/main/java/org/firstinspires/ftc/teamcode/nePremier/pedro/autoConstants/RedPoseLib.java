...
public final class RedPoseLib {
    public static int farStartX = 87; public static int farStartY = 9; public static int farStartR = 90;
    ...
    public static int nearShootX = 96; public static int nearShootY = 94; public static int nearShootR = 0;
    ...
    public static int Intake2X = 128; public static int Intake2Y = 63; public static int Intake2R = 0;
